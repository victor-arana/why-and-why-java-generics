...
public class StringCircularBufferTest {
    ...
    public void shouldOfferElement(){
        // Given a buffer with size > 0
        final int bufferSize = 1;
        StringCircularBuffer buffer = new StringCircularBuffer(bufferSize);
    ...
    public void shouldNotOfferWhenBufferIsFull(){
        // Given a full Circular Buffer with size > 0
        final int bufferSize = 1;
        StringCircularBuffer buffer = new StringCircularBuffer(bufferSize);
        buffer.offer("1");
        // When offering an element return false
        Assert.assertFalse(buffer.offer("2"));
    }
